...
public interface Screen extends Com4jObject {
  ...
  java.lang.String getStringEx(
    ...
    int endRow,
    int endCol,
    co.com.bancolombia.certificacion.vulcanofiduciaria.myextra.ATM_AREA area,
    co.com.bancolombia.certificacion.vulcanofiduciaria.myextra.ATM_WRAP wrap,
    int attr,
    int flags);
  ...
  int putStringEx(
    ...
    co.com.bancolombia.certificacion.vulcanofiduciaria.myextra.ATM_AREA area,
    co.com.bancolombia.certificacion.vulcanofiduciaria.myextra.ATM_WRAP wrap,
    co.com.bancolombia.certificacion.vulcanofiduciaria.myextra.ATM_PUTSTRING mode,
    boolean fill);
